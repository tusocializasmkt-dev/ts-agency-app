...
const CalendarView: React.FC<CalendarViewProps> = ({ selectedBrandId, isAdmin, onBrandChange }) => {
  ...
  const [selectedDay, setSelectedDay] = useState<Date | null>(null); const [editingPost, setEditingPost] = useState<Post | null>(null); const [viewingPost, setViewingPost] = useState<Post | null>(null); const [postOpen, setPostOpen] = useState(false);
