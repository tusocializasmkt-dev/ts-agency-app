...
function ClientDashboardContent({ brandId }: { brandId: string }) {
  ...
  return <div className="space-y-8">
    ...
    <div><div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between"><h2 className="text-2xl font-bold">Seus conteúdos</h2><Link to={ROUTES.client.calendar} className="min-h-11 self-start py-3 text-sm font-bold underline">Ver calendário</Link></div><FeedView selectedBrandId={brandId} isAdmin={false} /></div>
  </div>;
}
